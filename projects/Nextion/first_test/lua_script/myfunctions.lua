...
function serial_loop()
    while true do
        ...
        if data ~= nil then
            ...
            if debug then print('Timeout triggered. Waiting for user input...') end
            --binstr = string.char(0x74, 0x30, 0x2E, 0x74, 0x78, 0x74, 0x3d, 0x22, 0x31, 0x32, 0x33, 0x22, 0xff, 0xff, 0xff)
            --serial_port:write(binstr)
            --print(binstr)
        end
    end
end
